...
export default function EventDisplayer({events}:{events: (Event & {organiser: User})[]}) {
  return (
    ...
    {events.map(eventItem=><div key={eventItem.id} className="container-sm">
      <div>
        <Image width={200} height={100}  src={eventItem?.bgImageUrl || "https://media.traveler.es/photos/63aa3a712424e02f98a62399/16:9/w_2560%2Cc_limit/iStock-518820132.jpg"} alt="test" />
      </div>
         <div>
         {eventItem.title}
         </div>
